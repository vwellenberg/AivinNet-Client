...
- **Detail-Header haben eine feste Reihenfolge:** Play · Favorit · Pin · Zweitaktion · Overflow. Es gibt **vier** davon — Album, Artist, Playlist und **Mix** (`Mixes/MixesHeader.vue`, Route `/mix/:mixid`); der letzte wird beim Suchen leicht übersehen. Alle vier stehen als Gruppe in `_button-classes.scss` (Staffel-Versatz beim Aufploppen) — eine neue Header-Reihe dort mit eintragen.
